...
# 불용어 정의 및 제거
stop_words = "경우 사용 복직 신청 개월 출산휴가 육아휴직 급여 회사 휴직 가요 알바 소득 수당 차액 상한 확대 포지션 소진 할인"
...
# 불용어 제거 적용
df['post_preprocessed'] = df['post_preprocessed'].apply(lambda post: remove_stopwords(post, stop_words))
